...
export default function SwapButton() {
  ...
  const handleSwap = async () => {
    ...
    try {
      ...
      const amount1BN = parseUnits(amount, token1Decimals);
      // const amount2MinBN = parseUnits("1", token2Decimals); // accept at least 1
      const amount2MinBN = parseUnits("0.000001", 6); // 6 decimals for USDC
// const amount2Min = amount2MinBN.toBigInt();
      const amount1 = amount1BN;
      const amount2Min = amount2MinBN;
...
//       const USDC_ADDRESS = "0x968b9a5603ddeb2a78aa08182bc44ece1d9e5bf0"; // USDC.e on Story
//       const IP_ADDRESS = "0x1514000000000000000000000000000000000000"; // WIP token (wrapped IP)
...
//         expiration,
//         signer,
//         !isUSDCtoIP // useNative only when sending IP
//       );
